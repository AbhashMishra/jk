...
function setup() {
  ...
  icons1 = createSprite(530,height-40,width,50);
...
function draw() {  
  ...
  strokeWeight(5);
  stroke("lightblue");
  text("S",575,height-25);
  fill("pink");
  strokeWeight(5);
  stroke("pink");
  text("C",615,height-25);
  fill("yellow");
  strokeWeight(5);
  stroke("yellow");
  text("O",657,height-25);
  fill("lightgreen");
  strokeWeight(5);
  stroke("lightgreen");
  text("R",698,height-25);
  fill("orange");
  strokeWeight(5);
  stroke("orange");
  text("E",740,height-25);
  fill("white");
  strokeWeight(5);
  stroke("white");
  text("    :  "+ score,745,height-25);
